...
public class Caneta {
    ...
    public Caneta(){       // CADO POR TER O MESMO NOME DA CLASSE, COMO DITO NA
        this.cor = "Azul"; // AULA ANTERIOR ELE VAI SER RESPONSÁVEL POR JÁ INICIAR
        this.tampar();     //O PROGRAMA COM OS VALORES DENTRO DELE JÁ ATRIBUIDOS 
    }                      // ÀS VARIÁVEIS.NÃO USE VOID
    
    public String getModelo() {// quando eu tenho um método que vai ter um retorno
